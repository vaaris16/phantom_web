  ...
  return (
    <section className="flex flex-col gap-10 justify-center items-center">
      <div className="relative animate-fade-in-y">
        <h1
          className="absolute uppercase md:ml-0 ml-3 font-Montserrat font-bold text-6xl"
        ...
        <h1
          aria-hidden="true"
          className="relative md:ml-0 ml-3 uppercase font-Montserrat text-phantom blur-3xl opacity-100 font-bold text-6xl"
          style={{ paddingTop: "5rem" }}
        >
          meet the team
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 animate-reveal-y">
        {TeamData.map(({ name, skill, role }) => (
          <div className="relative group">
            <div className="absolute md:w-100 md:h-160 rounded-4xl bg-phantom blur-xl opacity-0 transition-all duration-500 group-hover:opacity-100 group-hover:-translate-y-3" />
